...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the BlueDataCluster resource tests

var _ = Describe("BlueDataCluster", func() {
    var instance BlueDataCluster
    var expected BlueDataCluster
